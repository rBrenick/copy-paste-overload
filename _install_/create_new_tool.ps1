...
$CURRENT_TOOLNAME = "copy_paste_overload"
$CURRENT_TOOLNAME_RAW = "copy-paste-overload"
...
# Find instances of copy_paste_overload in files and replace them with the new tool name
...
Foreach-Object {
    ...
    ((Get-Content -path $_.FullName -Raw) -replace "copy_paste_overload", $NEW_TOOLNAME_CLEAN) | Set-Content -Path $_.FullName
